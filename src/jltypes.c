...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    jl_typename_type->name->names = jl_perm_symsvec(10, "name", "module",
                                                    "names", "atomicfields",
                                                    "wrapper",
                                                    "cache", "linearcache",
                                                    "hash", "mt", "partial");
    jl_typename_type->types = jl_svec(10, jl_symbol_type, jl_any_type/*jl_module_type*/,
                                      jl_simplevector_type, jl_any_type/*jl_voidpointer_type*/,
                                      jl_type_type, jl_simplevector_type, jl_simplevector_type,
                                      jl_any_type/*jl_long_type*/, jl_methtable_type, jl_any_type);
